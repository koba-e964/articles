...
[wata さんのスライド](https://www.slideshare.net/wata_orz/ss-91375739) の p.47 を参照する。元の命題は以下のように言い換えられる:
...
[wata さんのスライド](https://www.slideshare.net/wata_orz/ss-91375739) の p.47 を参照する。元の問題は以下のように言い換えられる:
